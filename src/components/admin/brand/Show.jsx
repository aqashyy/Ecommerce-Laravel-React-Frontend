            ...
            <div className="container">
                <div className="row">
                    <div className="d-flex justify-content-between mt-5 pd-3">
                        <h3>Brands</h3>
                        <Link to="/admin/brands/create" className='btn btn-primary mb-2'>Create</Link>
                    </div>
                    ...
                    <div className="col-md-9">
                        ...
                        <div className="card shadow">
                            <div className="card-body p-4">
                                ...
                                {
                                    loader == false && brands.length == 0 && <Nostate text={"No brands found!"} />
                                }
                                {

...
const Show = () => {
    ...
    const deleteProduct = async (pId) => {
        ...
        if (confirm("Are you sure want to delete.?")) {
            await fetch(`${apiUrl}/products/${pId}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
            ...
            .then(result => {
                ...
                setProducts(
                    products.filter((prod) => prod.id != pId)
                )
            ...
            <div className="container">
                <div className="row">
                    <div className="d-flex justify-content-between mt-5 pd-3">
                        <h3>Products</h3>
                        <Link to="/admin/products/create" className='btn btn-primary mb-2'>Create</Link>
                    </div>
                    ...
                    <div className="col-md-9">
                        ...
                        <div className="card shadow">
                            <div className="card-body p-4">
                                ...
                                {
                                    loader == false && products.length == 0 && <Nostate text={"No products found!"} />
                                }
                                {
